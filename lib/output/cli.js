...
var Caml_array    = __webpack_require__(9);
var Acr_generator = __webpack_require__(30);
...
function to_field(data) {
  ...
  return /* record */[
          ...
          /* args */(match == null) ? /* None */0 : /* Some */[List.map(to_arg, $$Array.to_list(match))],
          /* fields */(match$1 == null) ? /* None */0 : /* Some */[List.map(to_field, $$Array.to_list(match$1))]
        ];
}
...
function to_operation(data) {
  ...
  return /* record */[
          ...
          /* variables */(match == null) ? /* None */0 : /* Some */[List.map(to_variable, $$Array.to_list(match))],
...
var Acr_utils       = __webpack_require__(34);
var Acr_type_parser = __webpack_require__(36);

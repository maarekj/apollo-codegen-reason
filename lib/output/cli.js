...
var Curry                   = __webpack_require__(1);
var Caml_obj                = __webpack_require__(5);
var Pervasives              = __webpack_require__(3);
var Caml_builtin_exceptions = __webpack_require__(0);
...
var Sys                     = __webpack_require__(19);
...
var Acr_ast       = __webpack_require__(25);
var Process       = __webpack_require__(30);
var Caml_array    = __webpack_require__(9);
var Acr_generator = __webpack_require__(31);

var queryJsonFile = Caml_array.caml_array_get(Process.argv, 2);

var queryJsonStr = Fs.readFileSync(queryJsonFile, "utf8");

var queryJson = JSON.parse(queryJsonStr);

var queryJson$1 = Acr_ast.from_json(queryJson);

console.log(Acr_generator.generate(queryJson$1));
...
exports.queryJsonFile = queryJsonFile;
exports.queryJsonStr  = queryJsonStr;
exports.queryJson     = queryJson$1;
/* queryJsonFile Not a pure module */
...
var Js_primitive = __webpack_require__(29);

function to_type(data) {
  return /* record */[
          /* kind */data.kind,
          /* name */data.name,
...
function to_field(data) {
  var match = data.args;
  var match$1 = data.fields;
  return /* record */[
          ...
          /* args */Js_primitive.is_nil_undef(match) ? /* None */0 : /* Some */[List.map(to_arg, $$Array.to_list(match))],
          /* fields */Js_primitive.is_nil_undef(match$1) ? /* None */0 : /* Some */[List.map(to_field, $$Array.to_list(match$1))]
        ];
}

function to_operation(data) {
  var match = data.variables;
  return /* record */[
          ...
          /* variables */Js_primitive.is_nil_undef(match) ? /* None */0 : /* Some */[List.map(to_variable, $$Array.to_list(match))],
          /* fields */List.map(to_field, $$Array.to_list(data.fields))
        ];
}

function to_file(data) {
  return /* record */[
          /* operations */List.map(to_operation, $$Array.to_list(data.operations)),
          /* fragments : [] */0,
          /* types_used */List.map(to_type, $$Array.to_list(data.typesUsed))
        ];
}

var from_json = to_file;

exports.to_type      = to_type;
exports.to_variable  = to_variable;
exports.to_arg_value = to_arg_value;
exports.to_arg       = to_arg;
exports.to_field     = to_field;
exports.to_operation = to_operation;
...
var Block           = __webpack_require__(6);
var Curry           = __webpack_require__(1);
var Printf          = __webpack_require__(17);
var Acr_utils       = __webpack_require__(35);
var Acr_type_parser = __webpack_require__(37);

function type_flatten_composed_fields(parent_name, field, sub_fields) {
  var sub_fields$1 = List.map((function (f) {
          var match = f[/* fields */6];
          if (match) {
            return Curry._2(Printf.sprintf(/* Format */[
                            ...
                            "  %s: %s"
                          ]), f[/* response_name */0], Acr_type_parser.to_reason_type(/* None */0, (function () {
                              return Curry._3(Printf.sprintf(/* Format */[
                                              ...
                                              "%s%s_%s"
                                            ]), parent_name, field[/* response_name */0], f[/* response_name */0]);
                            }), f[/* type_ */2]));
          } else {
            return Curry._2(Printf.sprintf(/* Format */[
                            /* String_literal */Block.__(11, [
                            ...
                            "  %s: %s"
                          ]), f[/* response_name */0], Acr_type_parser.to_reason_type(/* None */0, Acr_type_parser.scalar_to_reason, f[/* type_ */2]));
          }
        }), sub_fields);
  return Curry._3(Printf.sprintf(/* Format */[
                  /* String_literal */Block.__(11, [
                  ...
                  "type %s%s = {\n%s\n};"
                ]), parent_name, field[/* response_name */0], Acr_utils.join(",\n", sub_fields$1));
}

function type_flatten_fields(parent_name, field) {
  var match = field[/* fields */6];
  if (match) {
    var sub_fields = match[0];
    var partial_arg = parent_name + (field[/* response_name */0] + "_");
    return List.concat(/* :: */[
                List.concat(List.map((function (param) {
                            return type_flatten_fields(partial_arg, param);
                          }), sub_fields)),
                /* :: */[
                  /* :: */[
...
function convert_to_reason_composed_fields(parent_name, field, sub_fields) {
  var sub_fields$1 = List.map((function (f) {
          var match = f[/* fields */6];
          if (match) {
            return Curry._2(Printf.sprintf(/* Format */[
                            ...
                            "  %s: %s"
                          ]), f[/* response_name */0], Acr_type_parser.to_converter(/* Some */[/* false */0], Curry._3(Printf.sprintf(/* Format */[
                                    /* String_literal */Block.__(11, [
                                        "to_",
                                        /* String */Block.__(2, [
                                            /* No_padding */0,
                                    ...
                                    "to_%s%s_%s"
                                  ]), parent_name, field[/* response_name */0], f[/* response_name */0]), Curry._1(Printf.sprintf(/* Format */[
                                    /* String_literal */Block.__(11, [
                                        "data##",
                                        /* String */Block.__(2, [
                                            /* No_padding */0,
            ...
            return Curry._2(Printf.sprintf(/* Format */[
                            ...
                            "  %s: %s"
                          ]), f[/* response_name */0], Acr_type_parser.to_converter(/* Some */[/* false */0], "(fun x => x)", "data##" + f[/* response_name */0], f[/* type_ */2]));
          }
        }), sub_fields);
  return Curry._5(Printf.sprintf(/* Format */[
                ...
                ]), parent_name, field[/* response_name */0], parent_name, field[/* response_name */0], Acr_utils.join(",\n", sub_fields$1));
}

function query_variables_type(variables) {
  var variables$1 = List.map((function (variable) {
          return Curry._2(Printf.sprintf(/* Format */[
                          /* String_literal */Block.__(11, [
                              "  ",
                              /* String */Block.__(2, [
                          ...
                          "  %s: %s"
                        ]), variable[/* name */0], Acr_type_parser.to_reason_type(/* None */0, Acr_type_parser.scalar_to_reason, variable[/* type_ */1]));
        }), variables);
...
function convert_to_reason_fields(parent_name, field) {
  var match = field[/* fields */6];
  if (match) {
    var sub_fields = match[0];
    var partial_arg = parent_name + (field[/* response_name */0] + "_");
    return List.concat(/* :: */[
                List.concat(List.map((function (param) {
                            return convert_to_reason_fields(partial_arg, param);
                          }), sub_fields)),
                /* :: */[
                  /* :: */[
...
function variables_to_js(variables) {
  return List.map((function (variable) {
                return Curry._2(Printf.sprintf(/* Format */[
                                ...
                                "  \"%s\": %s"
                              ]), variable[/* name */0], Acr_type_parser.to_js_converter(Curry._1(Printf.sprintf(/* Format */[
                                        /* String_literal */Block.__(11, [
                                            "vars.",
                                            /* String */Block.__(2, [
                                                /* No_padding */0,
                                        ...
                                        "vars.%s"
                                      ]), variable[/* name */0]), variable[/* type_ */1]));
              }), variables);
}

function generate_operation(operation) {
  var res = Curry._2(Printf.sprintf(/* Format */[
            /* String_literal */Block.__(11, [
                "\nmodule ",
                /* String */Block.__(2, [
                    /* No_padding */0,
                    /* String_literal */Block.__(11, [
                        " = {\ntype gql;\nexternal gql : string => gql = \"graphql-tag\" [",
                                ...
                                /* String */Block.__(2, [
                                    ...
                                    /* String_literal */Block.__(11, [
                                        ...
                                        /* Formatting_lit */Block.__(17, [
                                            ...
                                            /* String_literal */Block.__(11, [
                                                "s];\ntype graphql 'a = (gql => Js.t 'a => hoc) [",
                                                /* Formatting_lit */Block.__(17, [
                                                    /* Scan_indic */Block.__(2, [/* "b" */98]),
                                                    /* String_literal */Block.__(11, [
                                                        "s];\nexternal _graphql: graphql 'a = \"graphql\" [",
                                                        /* Formatting_lit */Block.__(17, [
                                                            /* Escaped_at */5,
                                                            /* String_literal */Block.__(11, [
          ...
          ]), Acr_utils.capitalize(operation[/* operation_name */1]), operation[/* source */4]);
  var root_field = Acr_utils.first_or_fail(operation[/* fields */7]);
  var all_types = type_flatten_fields("", root_field);
  var all_converters = convert_to_reason_fields("", root_field);
  var res$1 = Curry._5(Printf.sprintf(/* Format */[
            /* String */Block.__(2, [
                /* No_padding */0,
                /* Char_literal */Block.__(12, [
                    /* "\n" */10,
            ...
            "%s\n%s\n\ntype data = {\n  loading: bool,\n  error: option Js.Exn.t,\n  network_status: React_apollo.networkStatus,\n  refetch: unit => unit,\n  %s: %s,\n};\n\n%s\n"
          ]), res, Acr_utils.join("\n\n", all_types), root_field[/* response_name */0], Acr_type_parser.to_reason_type(/* Some */[/* true */1], (function () {
              return root_field[/* response_name */0];
            }), root_field[/* type_ */2]), Acr_utils.join("\n\n", all_converters));
  var res$2 = Curry._3(Printf.sprintf(/* Format */[
            /* Char_literal */Block.__(12, [
                /* "\n" */10,
                /* String */Block.__(2, [
                    /* No_padding */0,
            ...
            "\n%s\n\nlet to_data (data: Js.t {..}): data => {\n  loading: Js.to_bool data##loading,\n  error: Js.Null_undefined.to_opt data##error,\n  network_status: React_apollo.to_network_status data##networkStatus,\n  %s: %s,\n  refetch: data##refetch,\n};\n"
          ]), res$1, root_field[/* response_name */0], Acr_type_parser.to_converter(/* Some */[/* true */1], Curry._1(Printf.sprintf(/* Format */[
                    /* String_literal */Block.__(11, [
                        "to_",
                        /* String */Block.__(2, [
                            /* No_padding */0,
                    ...
                    "to_%s"
                  ]), root_field[/* response_name */0]), Curry._1(Printf.sprintf(/* Format */[
                    /* String_literal */Block.__(11, [
                        "data##",
                        /* String */Block.__(2, [
                            /* No_padding */0,
                    ...
                    "data##%s"
                  ]), root_field[/* response_name */0]), root_field[/* type_ */2]));
  var variables = Acr_utils.def(/* [] */0, operation[/* variables */6]);
  return Curry._1(Printf.sprintf(/* Format */[
                  /* String */Block.__(2, [
                      /* No_padding */0,
                      /* String_literal */Block.__(11, [
                  ...
                  "%s\n};"
                ]), List.length(variables) ? Curry._3(Printf.sprintf(/* Format */[
                        /* String_literal */Block.__(11, [
                            "\n  ",
                            /* String */Block.__(2, [
                                /* No_padding */0,
                      ...
                      ]), res$2, query_variables_type(variables), Acr_utils.join(",\n", variables_to_js(variables))) : Curry._1(Printf.sprintf(/* Format */[
                        /* Char_literal */Block.__(12, [
                            /* "\n" */10,
                            /* String */Block.__(2, [
                                /* No_padding */0,
                                /* String_literal */Block.__(11, [
                                    "\n\nlet graphql ::component ::fromJs => {\n  let componentJsClass =\n    ReasonReact.wrapReasonForJs\n      ::component\n      (\n        fun (props: Js.t {..}) => {\n          let data: data = to_data props##data;\n          fromJs ::props ::data\n        }\n      );\n  (_graphql query (Js.Obj.empty ()) [",
                                    /* Formatting_lit */Block.__(17, [
                                        /* Scan_indic */Block.__(2, [/* "b" */98]),
                                        /* String_literal */Block.__(11, [
                                            "s]) componentJsClass [",
...
function generate(file) {
  var operations = List.map(generate_operation, file[/* operations */0]);
  return Acr_utils.join("\n\n", operations);
}
...
exports.Type_parser                       = Type_parser;
exports.sprintf                           = sprintf;
exports.type_flatten_composed_fields      = type_flatten_composed_fields;
exports.type_flatten_fields               = type_flatten_fields;
exports.convert_to_reason_composed_fields = convert_to_reason_composed_fields;
exports.query_variables_type              = query_variables_type;
exports.convert_to_reason_fields          = convert_to_reason_fields;
exports.variables_to_js                   = variables_to_js;
exports.generate_operation                = generate_operation;
exports.generate                          = generate;
/* Acr_utils Not a pure module */
...
var Js_exn    = __webpack_require__(10);
var Js_option = __webpack_require__(22);

function log_inspect($staropt$star, obj) {
  var depth = $staropt$star ? $staropt$star[0] : 10;
...
function first_or_fail(l) {
  if (l) {
    return l[0];
  } else {
    return Js_exn.raiseError("The list must be not empty");
  }
}
...
var space_regex = new RegExp("[\t\n\r ]+", "g");

var start_space_regex = new RegExp("^[\t\n\r ]+");

var end_space_regex = new RegExp("[\t\n\r ]+$");

function clear_space(str) {
  return str.replace(space_regex, " ");
}

function left_trim_space(str) {
  return str.replace(start_space_regex, "");
}

function right_trim_space(str) {
  return str.replace(end_space_regex, "");
}

function trim_space(str) {
  return str.replace(start_space_regex, "").replace(end_space_regex, "");
}

var def = Js_option.$$default;

exports.log_inspect       = log_inspect;
exports.first_or_fail     = first_or_fail;
exports.def               = def;
exports.join              = join;
exports.capitalize        = capitalize;
exports.space_regex       = space_regex;
exports.start_space_regex = start_space_regex;
exports.end_space_regex   = end_space_regex;
exports.clear_space       = clear_space;
exports.left_trim_space   = left_trim_space;
exports.right_trim_space  = right_trim_space;
exports.trim_space        = trim_space;
/* space_regex Not a pure module */
...
var ParsingError = Caml_exceptions.create("Acr_type_parser.ParsingError");

var NotYetSupported = Caml_exceptions.create("Acr_type_parser.NotYetSupported");

var MalformedType = Caml_exceptions.create("Acr_type_parser.MalformedType");

function raise_malformed_type(type_) {
  throw [
        MalformedType,
        type_,
        Curry._1(Printf.sprintf(/* Format */[
                  ...
                  "The type \"%s\" is malformed"
                ]), type_)
      ];
}

function create_lexer(str) {
  return /* record */[
          /* string */str,
          /* current_pos */0
        ];
...
var word_regex = new RegExp("[a-zA-Z_][a-zA-Z_0-9]*");

function get_token(lexer) {
  if (lexer[/* current_pos */1] >= lexer[/* string */0].length) {
    return /* EOS */3;
  } else {
    var $$char = Caml_string.get(lexer[/* string */0], lexer[/* current_pos */1]);
    if ($$char === /* "[" */91) {
      return /* LeftBrace */0;
    } else if ($$char === /* "]" */93) {
      return /* RightBrace */1;
      ...
      var next_string = lexer[/* string */0].substr(lexer[/* current_pos */1]);
      var match = word_regex.exec(next_string);
      if (match !== null) {
        return /* Word */[Caml_array.caml_array_get(match, 0)];
      } else {
        return /* EOS */3;
      }
    }
...
function inc_lexer(lexer) {
  var current_token = get_token(lexer);
  var inc = typeof current_token === "number" ? 1 : current_token[0].length;
  return /* record */[
          /* string */lexer[/* string */0],
          /* current_pos */Pervasives.min(lexer[/* current_pos */1] + inc | 0, lexer[/* string */0].length)
        ];
}
...
function parse(str) {
  ...
  var scalar_rule = function (lexer) {
    var match = get_token(lexer);
    if (typeof match === "number") {
      return /* None */0;
    } else {
      return /* Some */[/* tuple */[
                inc_lexer(lexer),
                /* Scalar */Block.__(1, [match[0]])
              ]];
    }
  };
  var array_rule = function (lexer) {
    var match = get_token(lexer);
    if (typeof match === "number") {
      if (match !== 0) {
        return /* None */0;
      } else {
        var lexer$1 = inc_lexer(lexer);
        var match$1 = main_rule(lexer$1);
        if (match$1) {
          var match$2 = match$1[0];
          var lexer$2 = match$2[0];
          var match$3 = get_token(lexer$2);
          if (typeof match$3 === "number" && match$3 === 1) {
            return /* Some */[/* tuple */[
                      inc_lexer(lexer$2),
  ...
  var main_rule = function (lexer) {
    var scalar = scalar_rule(lexer);
    var array = array_rule(lexer);
    var match = Js_option.firstSome(scalar, array);
    if (match) {
      var match$1 = match[0];
      var ast = match$1[1];
      var lexer$1 = match$1[0];
      var match$2 = get_token(lexer$1);
  ...
  var normalize_ast = function (_optional, _node) {
    while(true) {
      var node = _node;
      var optional = _optional;
      switch (node.tag | 0) {
        case 0 : 
            var n = /* Array */Block.__(0, [normalize_ast(/* true */1, node[0])]);
            if (optional !== 0) {
              return /* Optional */Block.__(2, [n]);
            } else {
              return n;
            }
        case 1 : 
            var n$1 = /* Scalar */Block.__(1, [node[0]]);
            if (optional !== 0) {
              return /* Optional */Block.__(2, [n$1]);
            } else {
              return n$1;
            }
        case 2 : 
  ...
  var match = main_rule(lexer);
  if (match) {
    return /* Some */[normalize_ast(/* true */1, match[0][1])];
  } else {
    return /* None */0;
  }
}

function parse_or_fail(str) {
  var match = parse(str);
  if (match) {
    return match[0];
  } else {
...
var Parser = /* module */[
  /* parse */parse,
  /* parse_or_fail */parse_or_fail
];

function is_bool(str) {
  if (str === "boolean" || str === "bool" || str === "Boolean") {
    return /* true */1;
  } else {
    return +(str === "Bool");
  }
...
function to_reason_type($staropt$star, scalar_to_reason, str) {
  var initial_optional = $staropt$star ? $staropt$star[0] : /* false */0;
  var _to_reason_type = function (node) {
    switch (node.tag | 0) {
      case 0 : 
          return Curry._1(Printf.sprintf(/* Format */[
                          /* String_literal */Block.__(11, [
                          ...
                          "list (%s)"
                        ]), _to_reason_type(node[0]));
      case 1 : 
          return Curry._1(scalar_to_reason, node[0]);
      case 2 : 
          return Curry._1(Printf.sprintf(/* Format */[
                          /* String_literal */Block.__(11, [
                              "option (",
  ...
  var match = parse(str);
  if (match) {
    if (initial_optional !== 0) {
      var node = match[0];
      switch (node.tag | 0) {
        case 0 : 
        case 1 : 
            return _to_reason_type(/* Optional */Block.__(2, [node]));
        case 2 : 
            return _to_reason_type(/* Optional */Block.__(2, [node[0]]));
        
      }
    } else {
      return _to_reason_type(match[0]);
    }
  } else {
    return raise_malformed_type(str);
  }
}

function to_converter($staropt$star, initial_mapper, field, type_) {
  var initial_optional = $staropt$star ? $staropt$star[0] : /* false */0;
  var apply_mapper = function (field, mapper) {
    if (mapper === "(fun x => x)") {
      return field;
    } else {
      return Curry._2(Printf.sprintf(/* Format */[
  ...
  var mapper_list = function (mapper) {
    if (mapper === "(fun x => x)") {
      return "Array.to_list";
    } else {
      return Curry._1(Printf.sprintf(/* Format */[
                      /* String_literal */Block.__(11, [
                          "Array.to_list |> List.map (",
                          /* String */Block.__(2, [
                              /* No_padding */0,
                              /* Char_literal */Block.__(12, [
                                  /* ")" */41,
                      ...
                      "Array.to_list |> List.map (%s)"
                    ]), mapper);
    }
  };
  var mapper_option = function (mapper) {
    if (mapper === "(fun x => x)") {
      return "Js.Null_undefined.to_opt";
    } else {
      return Curry._1(Printf.sprintf(/* Format */[
                      /* String_literal */Block.__(11, [
  ...
  var compose_mapper = function (mapper1, mapper2) {
    if (mapper1 === "(fun x => x)") {
      if (mapper2 === "(fun x => x)") {
        return "(fun x => x)";
      } else {
  ...
  var bool_mapper = compose_mapper(initial_mapper, "Js.to_bool");
  var _to_converter = function (node) {
    switch (node.tag | 0) {
      case 0 : 
          var match = node[0];
          switch (match.tag | 0) {
            case 0 : 
                throw NotYetSupported;
            case 1 : 
                var match$1 = is_bool(match[0]);
                var mapper = match$1 !== 0 ? bool_mapper : initial_mapper;
                return apply_mapper(field, mapper_list(mapper));
            case 2 : 
                var match$2 = match[0];
                switch (match$2.tag | 0) {
                  case 1 : 
                      var match$3 = is_bool(match$2[0]);
                      var mapper$1 = match$3 !== 0 ? bool_mapper : initial_mapper;
                      return apply_mapper(field, mapper_list(mapper_option(mapper$1)));
                  case 0 : 
                  case 2 : 
                      throw NotYetSupported;
          ...
          break;
      case 1 : 
          var match$4 = is_bool(node[0]);
          var mapper$2 = match$4 !== 0 ? bool_mapper : initial_mapper;
          return apply_mapper(field, mapper$2);
      case 2 : 
          var match$5 = node[0];
            ...
            case 0 : 
                ...
                switch (match$6.tag | 0) {
                  case 0 : 
                      throw NotYetSupported;
                  case 1 : 
                      var match$7 = is_bool(match$6[0]);
                      var mapper$3 = match$7 !== 0 ? bool_mapper : initial_mapper;
                      return apply_mapper(field, mapper_option(mapper_list(mapper$3)));
                  case 2 : 
                      var match$8 = match$6[0];
                      switch (match$8.tag | 0) {
                        case 1 : 
                            var match$9 = is_bool(match$8[0]);
                            var mapper$4 = match$9 !== 0 ? bool_mapper : initial_mapper;
                            return apply_mapper(field, mapper_option(mapper_list(mapper_option(mapper$4))));
                        case 0 : 
                        case 2 : 
                            throw NotYetSupported;
                ...
                break;
            case 1 : 
                var match$10 = is_bool(match$5[0]);
                var mapper$5 = match$10 !== 0 ? bool_mapper : initial_mapper;
                return apply_mapper(field, mapper_option(compose_mapper(mapper$5, "(fun x => x)")));
            case 2 : 
                throw NotYetSupported;
  ...
  if (match) {
    if (initial_optional !== 0) {
      ...
      switch (node.tag | 0) {
        case 0 : 
        case 1 : 
            return _to_converter(/* Optional */Block.__(2, [node]));
        case 2 : 
            return _to_converter(/* Optional */Block.__(2, [node[0]]));
        
      }
    } else {
      return _to_converter(match[0]);
    }
  } else {
    return raise_malformed_type(type_);
  }
}

function to_js_converter(field, type_) {
  var match = parse(type_);
  if (match) {
    var node = match[0];
    switch (node.tag | 0) {
      ...
      case 2 : 
          ...
          switch (match$1.tag | 0) {
            case 1 : 
                var b = match$1[0];
                if (is_bool(b) || b === "NullableBoolean") {
                  return Curry._1(Printf.sprintf(/* Format */[
                                  /* String_literal */Block.__(11, [
                                      "switch (",
                                      /* String */Block.__(2, [
...
exports.NotYetSupported      = NotYetSupported;
exports.MalformedType        = MalformedType;
exports.raise_malformed_type = raise_malformed_type;
exports.Lexer                = Lexer;
exports.Parser               = Parser;
exports.is_bool              = is_bool;
exports.scalar_to_reason     = scalar_to_reason;
exports.to_reason_type       = to_reason_type;
exports.to_converter         = to_converter;
exports.to_js_converter      = to_js_converter;
/* word_regex Not a pure module */
